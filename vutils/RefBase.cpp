...
#ifdef DEBUG_ENABLE
#define MY_LOGD_IF(cond,fmt, arg...)  XLOGD_IF(cond,LOG_TAG,fmt, ##arg)//MY_LOGD(fmt, ##arg)X
#else
...
bool RefBase::weakref_type::attemptIncStrong(const void* id)
{
    ...
    while (curCount > 0 && curCount != INITIAL_STRONG_VALUE) {
        ...
        if (vmodule_atomic_cmpxchg(curCount, curCount+1, &impl->mStrong) == 0) {
            break;
        }
